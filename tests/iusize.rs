...
#[cfg_attr(target_pointer_width = "64", case("-9223372036854775808", -9223372036854775808))]
fn test_strtoint_nonzero_isize(#[case] s: &str, #[case] x: isize) {
    assert_eq!(
...
fn test_strtoint_nonzero_isize_err(#[case] s: &str, #[case] err: StrToIntError) {
...
fn test_strtoint_nonzero_usize(#[case] s: &str, #[case] x: usize) {
    assert_eq!(
...
fn test_strtoint_nonzero_usize_err(#[case] s: &str, #[case] err: StrToIntError) {
